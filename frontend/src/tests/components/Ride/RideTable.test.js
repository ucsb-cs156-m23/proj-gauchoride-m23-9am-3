...
describe("RideTable tests", () => {
  ...
  test("Has the expected column headers and content for adminUser", () => {
    ...
    const expectedFields = ['id', 'day', 'student', 'driver', 'course', 'startTime', 'endTime', 'pickupLocation', 'pickupRoom', 'dropoffLocation', 'dropoffRoom', 'notes'];
  ...
  test("Has the expected column headers and content for ordinary rider", () => {
    ...
    const expectedFields = ['id', 'day', 'driver', 'course', 'startTime', 'endTime', 'pickupLocation', 'pickupRoom', 'dropoffLocation', 'dropoffRoom', 'notes'];
    const testId = "RideTable";
  ...
  test("Has the expected column headers and content for ordinary driver", () => {
    ...
    const expectedFields = ['id', 'day', 'student', 'course', 'startTime', 'endTime', 'pickupLocation', 'pickupRoom', 'dropoffLocation', 'dropoffRoom', 'notes'];
    const testId = "RideTable";
