...
describe("ShiftTable tests", () => {
    ...
    test("Has expected column headers and content for driverUser", () => {
    ...
    test("Edit button navigates to the edit page as driverUser", async () => {
        // arrange
        const currentUser = currentUserFixtures.driverOnly;
    ...
    test("Delete button calls delete callback for driverUser", async () => {
